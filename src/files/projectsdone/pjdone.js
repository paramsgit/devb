...
{/* <Link to="/hostel" target={'_blank'}> */}
       <Postcp link='/hostel' demo='Demo' br={br} width={roomwidth} height={roomheight} image={gatetoken} />
       {/* </Link> */}
  ...
  const [gatephoto, setgatephoto] = useState(n_photo72);
  const [gatetoken, setgatetoken] = useState(n_photo8);
...
<div className="cert_heading" id="cheadt">
  <h1 className="certf_title">P<span style={{margin:"0 3px"}} className="greenN">r</span> ojects</h1>
</div>

<div style={{marginTop:0}} className="gatepass">
